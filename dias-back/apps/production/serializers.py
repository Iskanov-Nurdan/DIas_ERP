...
from .models import Line, LineHistory, Order, ProductionBatch, Shift, ShiftNote
...
class ShiftSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Shift
        fields = (
            'id', 'line', 'line_name', 'user', 'user_name',
    ...
    def get_line_name(self, obj):
        return obj.line.name if obj.line_id else None
